#
#  Be sure to run `pod spec lint MZInsetLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "veryitman"
  # s.authors            = { "veryitman" => "veryitman@126.com" }
  # s.social_media_url   = "http://twitter.com/veryitman"
